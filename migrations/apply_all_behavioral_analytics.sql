-- ===================================================================
-- COMPLETE BEHAVIORAL ANALYTICS MIGRATION
-- Run this entire file in your Supabase SQL Editor
-- ===================================================================

-- STEP 1: Fix Missing Fields in request_behaviors Table
-- ===================================================================
...
-- STEP 2: Create Behavioral Analytics Functions and Views
-- ===================================================================
...
DO $$
BEGIN
  RAISE NOTICE 'Testing behavioral analytics functions...';
  
  -- Test dashboard summary
  PERFORM * FROM get_dashboard_summary('2024-01-01'::date, '2024-12-31'::date, NULL);
  RAISE NOTICE '✅ get_dashboard_summary works!';
  
  -- Test weekly summary
  PERFORM * FROM get_dashboard_summary_weekly('2024-01-01'::date, '2024-12-31'::date, NULL);
  RAISE NOTICE '✅ get_dashboard_summary_weekly works!';
  
  -- Test suggestion funnel
  PERFORM * FROM get_suggestion_funnel('2024-01-01'::date, '2024-12-31'::date, NULL);
  RAISE NOTICE '✅ get_suggestion_funnel works!';
  
  -- Check view
  PERFORM COUNT(*) FROM v_behavior_suggestions;
  RAISE NOTICE '✅ v_behavior_suggestions view works!';
  
  RAISE NOTICE '';
  RAISE NOTICE '🎉 All behavioral analytics features installed successfully!';
END $$;