-- Fix Database Functions to Use Correct Field Names
-- This script updates the functions to use 'total_amount' instead of 'amount'
...
-- 6. Test the corrected functions
...
SELECT 'Testing Purchase Behavior Function:' as test_name;
SELECT * FROM public.get_purchase_behavior_by_age(
    '2025-01-01'::TIMESTAMPTZ, 
    '2025-12-31'::TIMESTAMPTZ
) LIMIT 5;
