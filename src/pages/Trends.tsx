    ...
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-5">
              ...
              <div>
                <label className="mb-2 block text-sm font-medium text-gray-700">Dimension</label>
            ...
            <Card>
              <CardContent className="flex items-center p-6">
                ...
                <div className="ml-4">
                  ...
                  <p
                    className={`text-2xl font-bold ${trendIndicators.isPositive ? 'text-green-600' : 'text-red-600'}`}
                  >
                    {trendIndicators.isPositive ? '+' : '-'}
                    {trendIndicators.change.toFixed(1)}%
                  </p>
            ...
            <Card>
              <CardContent className="flex items-center p-6">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-1 text-xs text-muted-foreground">Recent period</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="flex items-center p-6">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-1 text-xs text-muted-foreground">Previous period</p>
                </div>
              </CardContent>
            </Card>
          </div>
        ...
        <Card>
          <CardHeader>
            <CardTitle>
              {metrics.find(m => m.value === selectedMetric)?.label} by{' '}
