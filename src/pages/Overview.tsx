  ...
  return (
    <DashboardErrorBoundary>
      <div className="space-y-6">
        ...
        {/* Power BI Style Header - "What's Happening" Section */}
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-lg font-medium text-blue-600">Real-Time Market Overview</p>
              </div>
            </div>
            <p className="max-w-2xl text-gray-600">
              Get an instant snapshot of your retail performance across all channels. Monitor live
              transactions, track revenue trends, and identify top-performing brands in real-time.
            </p>
          </div>
        ...
        <Card className="border-blue-200 bg-gradient-to-r from-blue-50 to-indigo-50">
          ...
          <CardContent>
            <div className="flex items-center justify-between">
              ...
              <div className="ml-6">
                <Button
                  onClick={() => (window.location.href = '/geospatial-performance')}
