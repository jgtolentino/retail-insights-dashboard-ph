...
export const useFilterStore = create<FilterStore>()(
  subscribeWithSelector((set, get) => ({
    ...
    setSelectedStores: (stores) => 
      set({ selectedStores: stores }),
    
    setSelectedAgeGroups: (ageGroups) => 
      set({ selectedAgeGroups: ageGroups }),
    
    setSelectedGenders: (genders) => 
      set({ selectedGenders: genders }),
    
    setSelectedIncomeRanges: (incomeRanges) => 
      set({ selectedIncomeRanges: incomeRanges }),
...
export const useFilterSelectors = {
  dateRange: () => useFilterStore((state) => state.dateRange),
  selectedBrands: () => useFilterStore((state) => state.selectedBrands),
  selectedCategories: () => useFilterStore((state) => state.selectedCategories),
  selectedRegions: () => useFilterStore((state) => state.selectedRegions),
  selectedStores: () => useFilterStore((state) => state.selectedStores),
  allFilters: () => useFilterStore((state) => ({
