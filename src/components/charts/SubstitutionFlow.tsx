          ...
          <div className="space-y-6">
            ...
            <div className="relative">
              ...
              <div className="pointer-events-none absolute inset-0">
                <svg className="h-full w-full" style={{ zIndex: 1 }}>
            ...
            <div className="border-t pt-4">
              <h3 className="mb-3 text-sm font-medium">Key Substitution Insights</h3>
                  ...
                  <div key={index} className="rounded-lg border bg-gray-50 p-3">
                    ...
                    <div className="flex items-center gap-3 text-xs text-gray-600">
                      ...
                      {pattern.avg_price_diff !== 0 && (
                        ...
                        >
                          {pattern.avg_price_diff > 0 ? '+' : ''}₱
                          {pattern.avg_price_diff.toFixed(2)}
                        </span>
                      )}
                    </div>
                  </div>
            ...
            {/* Legend */}
            <div className="flex items-center gap-6 border-t pt-2 text-xs text-gray-600">
              <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-2">
                <div className="h-1 w-8 rounded bg-gradient-to-r from-red-500 via-yellow-500 to-green-500"></div>
