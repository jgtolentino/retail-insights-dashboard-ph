...
export function GenderDistribution({ startDate, endDate }: GenderDistributionProps) {
  ...
  const malePercentage = maleData?.percentage || (total > 0 ? Math.round((maleCount / total) * 100) : 0);
  const femalePercentage = femaleData?.percentage || (total > 0 ? Math.round((femaleCount / total) * 100) : 0);
      ...
      <CardContent>
        ...
        <div className="flex justify-center gap-12 py-8">
          <div className="flex flex-col items-center gap-2">
            <div className="w-20 h-20 rounded-full flex items-center justify-center border-2 border-blue-200">
              <MaleIcon className="w-14 h-14 text-blue-600" />
            </div>
          ...
          <div className="flex flex-col items-center gap-2">
            <div className="w-20 h-20 rounded-full flex items-center justify-center border-2 border-pink-200">
              <FemaleIcon className="w-14 h-14 text-pink-600" />
            </div>
            <div className="text-center">
