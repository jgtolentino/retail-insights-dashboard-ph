  ...
  features: [
    {
      ...
      geometry: {
        type: "Polygon",
        coordinates: [[[121.0, 14.4], [121.1, 14.4], [121.1, 14.7], [121.0, 14.7], [121.0, 14.4]]]
      }
    },
    {
      type: "Feature",
      ...
      geometry: {
        type: "Polygon",
        coordinates: [[[120.3, 14.8], [121.2, 14.8], [121.2, 16.0], [120.3, 16.0], [120.3, 14.8]]]
      }
    },
    {
      type: "Feature",
      ...
      geometry: {
        type: "Polygon",
        coordinates: [[[120.8, 13.5], [121.8, 13.5], [121.8, 14.8], [120.8, 14.8], [120.8, 13.5]]]
      }
    },
    {
      type: "Feature",
      ...
      geometry: {
        type: "Polygon",
        coordinates: [[[123.3, 9.5], [124.2, 9.5], [124.2, 11.0], [123.3, 11.0], [123.3, 9.5]]]
      }
    }
  ]
} as any;
        ...
        <div style={{ height, position: 'relative' }}>
          ...
          {showLegend && salesData && salesData.length > 0 && (
            <div className="absolute bottom-4 right-4 bg-white p-3 rounded-lg shadow-md z-[1000]">
              <h4 className="text-xs font-semibold mb-2">Sales Volume</h4>
